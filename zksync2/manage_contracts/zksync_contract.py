...
class ZkSyncContract:
    ...
    def get_priority_queue_size(self) -> int:
        return self._method_("getL2SystemContractsUpgradeTxHash")().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
    ...
    def get_security_council(self) -> HexStr:
        return self._method_("getName")().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
    ...
    def get_total_blocks_committed(self) -> int:
        return self._method_("getProtocolVersion")().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
    ...
    def get_total_blocks_executed(self) -> int:
        return self._method_("getTotalBatchesCommitted")().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
    ...
    def get_total_blocks_verified(self) -> int:
        return self._method_("getTotalBatchesExecuted")().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
    ...
    def get_total_priority_txs(self):
        return self._method_('getTotalBatchesVerified')().call(
            {
                "chainId": self.chain_id,
                "from": self.account.address,
                'nonce': self._nonce(),
