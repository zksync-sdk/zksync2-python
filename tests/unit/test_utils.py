...
class UtilsTest(TestCase):
    ...
    def test_apply_l1_to_l2_alias(self):
        ...
        self.assertEqual(l2_contract_address.lower(), "0x813A42B8205E5DedCd3374e5f4419843ADa77FFC".lower())
    ...
    def test_undo_l1_to_l2_alias(self):
        ...
        self.assertEqual(l1_contract_address.lower(), "0x702942B8205E5dEdCD3374E5f4419843adA76Eeb".lower())
